...
This is my configuration file for (Doom) Emacs. It is written using [[https://orgmode.org/][org mode]],
...
This replaces the default DOOM logo with the standard Emacs one, located in =.doom.d/images=.
#+BEGIN_SRC emacs-lisp
